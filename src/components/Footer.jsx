          ...
          <div className="flex flex-col md:flex-row justify-between items-center">
            <div className="flex flex-wrap justify-center md:justify-start gap-6 text-sm text-gray-400 mb-6 md:mb-0">
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div className="absolute bottom-full left-0 mb-3 w-64 bg-gray-800 border border-gray-600 text-gray-300 text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  We collect and process your personal data to provide our job portal services. Your data is never sold to third parties. You have the right to access, correct, or delete your information at any time.
              ...
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-primary-600/20 to-purple-600/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -inset-2"></div>
                <div className="absolute bottom-full left-1/2 -translate-x-1/2 mb-3 w-64 bg-gray-800 border border-gray-600 text-gray-300 text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  By using JobPortal, you agree to our terms. Users must be 18+ to post jobs. We reserve the right to remove listings that violate our community guidelines. Misuse of the platform may result in account suspension.
              ...
              <a className="group relative hover:text-white transition-colors duration-300 cursor-pointer">
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-primary-600/20 to-purple-600/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -inset-2"></div>
                <div className="absolute bottom-full right-0 mb-3 w-64 bg-gray-800 border border-gray-600 text-gray-300 text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  We use cookies to enhance your browsing experience, remember your preferences, and analyze site traffic. Essential cookies are required for the site to function. You can manage optional cookies through your browser settings.
                  <div className="absolute top-full right-4 border-4 border-transparent border-t-gray-600"></div>
                </div>
              </a>
              <Link
                to="/contact"
              ...
              >
                ...
                <div className="absolute inset-0 bg-gradient-to-r from-primary-600/20 to-purple-600/20 rounded-lg opacity-0 group-hover:opacity-100 transition-opacity duration-300 -inset-2"></div>
                <div className="absolute bottom-full right-0 mb-3 w-64 bg-gray-800 border border-gray-600 text-gray-300 text-xs rounded-lg p-3 opacity-0 group-hover:opacity-100 transition-opacity duration-300 pointer-events-none z-50 shadow-xl">
                  Have a question or facing an issue? Reach out to our admin team and we'll get back to you as soon as possible.
                  <div className="absolute top-full right-4 border-4 border-transparent border-t-gray-600"></div>
                </div>
              </Link>
            </div>
